...
import os
import re
from data import get_initial_timestamp
...
class Test_Data(unittest.TestCase):
    ...
    def test_timestamps_correctness(self):
        for i in range(1, len(self.timestamps)):
            ...
            self.assertEqual(current_timestamp - datetime.timedelta(microseconds=1000 * 20), previous_timestamp, "Should be the same")
