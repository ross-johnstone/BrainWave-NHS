...
def login_page_screen():
    ...
    # add text entries2
    username_entry = Entry(master=login_page, width="32", exportselection=0)
    username_entry.place(x=52, y=180)

    password_entry = Entry(master=login_page, width="32", show="*", exportselection=0)
    ...
    login_button = Button(text="Login", width="17", command=signup_screen, font=("Consolas", 15))
