...
class TestAnnotations(unittest.TestCase):
    ...
    def test_generate_annotations(self):
        annotation = Annotation("Annotation 1", "This is the first test annotation.", 100, 250)
        self.assertEqual(annotation.title, "Annotation 1", "Should be Annotation 1")
    ...
    def test_encode_decode_annotation(self):
        annotation = Annotation("Annotation", "Encoding Annotation", 100, 250)
